 ...
 * PROJECT: AB Emissor
 * TYPE: Model
 * FILE: app/Models/NfeInutilizacao.php
 *
...
{
    protected $table = 'fis_nfe_inutilizacoes';

    protected $fillable = ['empresa_id', 'usuario_id', 'ambiente', 'serie', 'numero_inicial', 'numero_final', 'justificativa', 'status'];
}
